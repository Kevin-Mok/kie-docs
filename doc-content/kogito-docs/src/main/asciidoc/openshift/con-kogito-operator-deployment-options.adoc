...
$ {PRODUCT_INIT} deploy-service travels travels/ --native
----
...
The following example is a memory request configuration for the https://github.com/kiegroup/kogito-examples/tree/stable/process-quarkus-example[`process-quarkus-example`] example application:
